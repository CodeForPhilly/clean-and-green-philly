...
output_schema = DataFrameSchema(
    {
        "l_and_i_complaints_density": Column(
            float, checks=[*distribution_check(density_params)]
        ),
        "l_and_i_complaints_density_zscore": Column(
            float, checks=[*distribution_check(zscore_params)]
        ),
        "l_and_i_complaints_density_label": Column(str),
        "l_and_i_complaints_density_percentile": Column(
