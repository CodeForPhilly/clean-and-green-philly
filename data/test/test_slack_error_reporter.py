...
from src.classes.slack_error_reporter import (
...
class TestSlackNotifier(unittest.TestCase):
    @patch(
        "src.classes.slack_error_reporter.WebClient.chat_postMessage"
    )  # Correct patching
    @patch(
        "src.classes.slack_error_reporter.os.getenv",
    ...
    @patch(
        "src.classes.slack_error_reporter.os.getenv", return_value=None
