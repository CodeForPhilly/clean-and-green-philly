  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flew-grow container mx-auto pt-20">
        ...
        <p>
          A private land use agreement can be a fast and easy way to get access
          to a property, provided that you are able to find the owner of the
          property. When creating such an agreement, you must define the rights
          and responsibilities of yourself and the property owner. Grounded in
          Philly provides a good list of key considerations
        ...
        <p>
          ...
          short, if a property meets certain specific criteria, it can be turned
          over to a court-appointed conservator for remediation. According to
          the law, it must be unoccupied, abandoned by its owner, and unsafe and
          unhealthy. (For more information, consult this explanation of Act 135.
          ...
          to appoint them as the conservator of the property. The conservator is
          then the owner of the property and can improve it as they see fit.
          However, as mentioned, taking this approach requires legal support and
          significant financial resources. It is therefore not an ideal route
          for small organizations, but may be an option for better-resourced
          organizations such as affordable housing developers.
        </p>
        ...
        <p>
          ...
          Philadelphia Housing Development Corporation. It works to redistribute
          publicly-owned land and return vacant properties to productive use.
          Vacant properties owned by the Land Bank can often be acquired for
          nominal or discounted prices for certain kinds of uses or projects.
          ...
          process, which also requires the support of the City Council member in
          whose district the property falls. Grounded in Philly provides a good
          overview of how to get permission to use City land
