  ...
  return (
    <div className="grid grid-cols-2 gap-4 py-8 px-24">
      ...
      <div className="container mx-auto">
        ...
        <p className="text-lg">
          All of the code used to build this tool is <a href="https://github.com/CodeForPhilly/vacant-lots-proj" target="_blank" rel="noopener noreferrer" className="text-primary">available on our GitHub repository</a>. We hope to add data documentation in the near future. For further questions about our methods, feel free to reach out to us at <a href="mailto:cleanandgreenphl@gmail.com" className="text-primary">cleangreenphilly@gmail.com</a>.
        </p>
        <br></br>
        <h2 className="text-3xl font-semibold mb-4">Who built this?</h2>
        <p className="text-lg mb-4">
        Clean & Green Philly was built by a team of Code for Philly volunteers. The project was created and led by <a href="https://www.nlebovits.github.io" target="_blank" rel="noopener noreferrer" className="text-primary">Nissim Lebovits</a>. <a href="https://www.willonabike.com" target="_blank" rel="noopener noreferrer" className="text-primary">Will Budreau</a> was responsible for user testing and research, <a href="https://wwww.brandonfcohen.com" target="_blank" rel="noopener noreferrer" className="text-primary">Brandon Cohen</a> was the lead developer, and <a href="https://www.nathanielsidwell.com" target="_blank" rel="noopener noreferrer" className="text-primary"> Nathaniel Sidwell</a> led the UX team. Thanks, too, to the many other contributors along the way.
        </p>
        <p className="text-lg mb-4">
