  ...
  return (
    <div className="grid grid-cols-2 gap-4 py-8 px-24">
      ...
      <div className="container mx-auto">
        ...
        <p className="text-lg mb-4">
        Clean & Green Philly was built by a team of Code for Philly volunteers. The project was created and led by <a href="nlebovits.github.io" target="_blank" rel="noopener noreferrer" className="text-primary">Nissim Lebovits</a>. <a href="willonabike.com" target="_blank" rel="noopener noreferrer" className="text-primary">Will Budreau</a> was responsible for user testing and research, <a href="brandonfcohen.com" target="_blank" rel="noopener noreferrer" className="text-primary">Brandon Cohen</a> was the lead developer, and <a href="nathanielsidwell.com" target="_blank" rel="noopener noreferrer" className="text-primary"> Nathaniel Sidwell</a> led the UX team. Thanks, too, to the many other contributors along the way.
        </p>
        <p className="text-lg mb-4">
