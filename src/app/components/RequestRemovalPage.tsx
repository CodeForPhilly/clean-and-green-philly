    ...
    <div className="flex flex-col min-h-screen">
      <div className="container mx-auto pt-20">
        ...
        <p>
          ...
          address of the property and a thorough explanation of your reasons for
          requesting its removal. Documentation such as photos of the site in
          use are encouraged. We will review the reason for your request and
          respond as quickly as we can. In making our decision, we will consider
          whether we believe the request is reasonable and consistent with
          positive community impact and anti-gun violence initiatives.
          <br></br>
          <br></br>
          ...
          private parking spaces or assisting negligent property owners, will
          not be entertained. By submitting a request, you acknowledge and agree
          that the final decision rests with our team, and not all requests may
          result in the removal of a property listing.
        </p>
      </div>
    </div>
  );
