...
const RecommendedActions = () => (
  <div className="container mx-auto pt-20 h-screen">
    <div className="text-left text-2xl my-10">
      ...
      <h2 className="text-2xl font-bold mt-4">Decision Tree</h2>
      <p>Content for the Decision Tree section...</p>

      <h2 className="text-2xl font-bold mt-4">Potential Uses for Parcels</h2>
      <p>Content for the Potential Uses for Parcels section...</p>

      <h1 className="text-3xl font-bold mt-4">Things to Consider</h1>
      <p>Content for the Things to Consider section...</p>

      <h2 className="text-2xl font-bold mt-4">Funding</h2>
      <p>Content for the Funding section...</p>

      <h2 className="text-2xl font-bold mt-4">Maintenance</h2>
      <p>Content for the Maintenance section...</p>

      <h2 className="text-2xl font-bold mt-4">Gentrification</h2>
      <p>Content for the Gentrification section...</p>
