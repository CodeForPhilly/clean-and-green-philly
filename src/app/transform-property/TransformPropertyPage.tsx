...
export default function TransformPropertyPage() {
  return (
    <div>
      ...
      <p className="body-md">
        Clean & Green Philly aims to help reduce gun violence by intervening in
        vacant properties. Very simply, this means improving the property. This
        can range from removing trash to planting a community garden, from
        trimming trees to building affordable housing. Below, we lay out ways to
        transform a vacant property into something that positively impacts the
      ...
      <p className="body-md">
        ...
        impact. That said, there are many ways to transform a vacant property.
      ...
      <p className="body-md">
        ...
        still helpful here in Philadelphia. Also, remember to think about other
