export default function TakeActionOverviewPage() {
  return (
    <div>
      ...
      <p className="body-md">
        Clean & Green Philly can help you prioritize vacant properties to return
        to productive use. We encourage cleaning and greening interventions, but
        also recognize that there is no one-size-fits-all solution. To address
        gun violence and vacancy in Philadelphia, we will need a range of
        interventions, each tailored to local context. Below, we lay out ways
        that you can use this site to identify a property, understand how to get
        legal access to it, and think about the ways in which you might best
        return it to productive use—whether through cleaning and greening or
        otherwise.
      </p>

      <h2 className="heading-2xl font-bold mt-8">What can I do?</h2>
      <p className="body-md">
        Using this site, you can identify a high impact property, figure out how
        to get legal access to it, and decide on your preferred intervention to
        return the lot to productive use.
      </p>
